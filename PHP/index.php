    ...
    <main>
        <div class="table_wrapper">
            ...
            <div class="table">
                ...
                <?php // pěkně napíču to tady 3x kopírovat ale udělat to přes funkci mi nešlo
                    $button = "<td><input type='checkbox' onchange='handleChange(this)'";
            ...
            <div class="table">
                ...
                <table>
                    ...
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        while ($tituly_row = mysqli_fetch_assoc($tituly_result)) { // napsat vnořený while cykly je pěkná píčovina 
                        echo "<tr>";
